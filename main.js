...
if (e.shiftKey==true&& keyPressed=='80') {
    ...
    console.log("shift+p al mismo tiempo");
...
if (e.shiftKey==true&& keyPressed=='77') {
    ...
    console.log("shift+m al mismo tiempo");
...
function up()
{
    if(player_y >=0)
    {
        ...
        canvas.remove(player_object); //remove es para quitar el rastro del objeto cuando se mueve
...
function down()
{
    if(player_y <=500)
    {
        ...
        console.log("cuando se presiona la flecha haca abajo, X = "+ player_x +" , Y ="+ player_y);
